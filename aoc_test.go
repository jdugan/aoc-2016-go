...
func Test(t *testing.T) {
	...
	g.Describe("AOC", func() {
		g.It("Should get correct answers for Day 01", func() {
			g.Assert(day01.Puzzle1()).Equal(226)
			g.Assert(day01.Puzzle2()).Equal(79)
		})
		g.It("Should get correct answers for Day 02", func() {
			g.Assert(day02.Puzzle1()).Equal("38961")
			g.Assert(day02.Puzzle2()).Equal("46C92")
		})
		g.It("Should get correct answers for Day 03", func() {
			g.Assert(day03.Puzzle1()).Equal(917)
			g.Assert(day03.Puzzle2()).Equal(1649)
		})
		g.It("Should get correct answers for Day 04", func() {
			g.Assert(day04.Puzzle1()).Equal(409147)
			g.Assert(day04.Puzzle2()).Equal(991)
		})
		g.It("Should get correct answers for Day 05", func() {
			g.Assert(day05.Puzzle1()).Equal("801b56a7")
			g.Assert(day05.Puzzle2()).Equal("424a0197")
		})
		g.It("Should get correct answers for Day 06", func() {
			g.Assert(day06.Puzzle1()).Equal("qoclwvah")
			g.Assert(day06.Puzzle2()).Equal("ryrgviuv")
		})
		g.It("Should get correct answers for Day 07", func() {
			g.Assert(day07.Puzzle1()).Equal(115)
			g.Assert(day07.Puzzle2()).Equal(231)
		})
		g.It("Should get correct answers for Day 08", func() {
			g.Assert(day08.Puzzle1()).Equal(116)
			g.Assert(day08.Puzzle2()).Equal("UPOJFLBCEZ")
		})
		g.It("Should get correct answers for Day 09", func() {
			g.Assert(day09.Puzzle1()).Equal(70186)
			g.Assert(day09.Puzzle2()).Equal(-2)
		})
		g.It("Should get correct answers for Day 10", func() {
			g.Assert(day10.Puzzle1()).Equal(141)
			g.Assert(day10.Puzzle2()).Equal(1209)
		})
		g.It("Should get correct answers for Day 11", func() {
			g.Assert(day11.Puzzle1()).Equal(-1)
			g.Assert(day11.Puzzle2()).Equal(-2)
		})
		g.It("Should get correct answers for Day 12", func() {
			g.Assert(day12.Puzzle1()).Equal(-1)
			g.Assert(day12.Puzzle2()).Equal(-2)
		})
